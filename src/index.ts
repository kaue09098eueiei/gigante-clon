...
client.on("ready", async () => {
  ...
  const guild = client.guilds.cache.get('1203719828490289172');
  if (guild) {
    const channel = guild.channels.cache.get('1203719828490289172');
  ...
  const r = new Discord.RichPresence()
    .setApplicationId('1203719828490289172')
    .setType('PLAYING')
    .setURL('https://discord.com/invite/w9fRC4XCuV')
    .setName('Mouraa Clones')
    .setState('Running...')
    .setDetails('O melhor criador sobre bots ')
    .setAssetsLargeImage('https://media.discordapp.net/attachments/1203719886623473714/1203806547021533254/gta-sa-heaven-roleplay.png?ex=65d26f36&is=65bffa36&hm=e9421b70ba346e9a760eafdcbf3ea385a5b6c3289401222f1c59a1400b0d34f1&')
    .setAssetsLargeText('Mouraa Clones')
    .setAssetsSmallImage('https://media.discordapp.net/attachments/1203719886623473714/1203806547021533254/gta-sa-heaven-roleplay.png?ex=65d26f36&is=65bffa36&hm=e9421b70ba346e9a760eafdcbf3ea385a5b6c3289401222f1c59a1400b0d34f1&')
    .setAssetsSmallText('Join')
    .setStartTimestamp(dateFromTimestamp)
    .addButton('Join', 'https://discord.com/invite/w9fRC4XCuV');
