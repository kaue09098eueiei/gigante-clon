...
client.on("ready", async () => {
  ...
  const r = new Discord.RichPresence()
    ...
    .setType('PLAYING')
    .setURL('https://discord.gg/brasilfortcarson')
    .setName('Gigante Clones')
    .setState('Running...')
    .setDetails('O melhor criador sobre bots ')
    .setAssetsLargeImage('https://i49.servimg.com/u/f49/20/55/18/30/picsar10.png')
    .setAssetsLargeText('Mouraa Clones')
    .setAssetsSmallImage('https://i49.servimg.com/u/f49/20/55/18/30/picsar10.png')
    .setAssetsSmallText('Join')
    .setStartTimestamp(dateFromTimestamp)
    .addButton('Join', 'https://discord.gg/brasilfortcarson');
