    ...
    async (choice) => {
      ...
      switch (choice) {
        ...
        case "7":
          ...
          console.log(
            gradient(["red", "purple"])(
              "Link: https://discord.com/invite/w9fRC4XCuV"
            )
          );
          awaitenter(client);
          break;
...
export function creatorname() {
  ...
  console.log(
    gradient(["#ff4500", "#ffa500", "#ff6347"])(`
           __  __  ___  _   _ ____      _        _          ____ _     ___  _   _ _____ ____  
 |  \/  |/ _ \| | | |  _ \    / \      / \        / ___| |   / _ \| \ | | ____|  _ \ 
 | |\/| | | | | | | | |_) |  / _ \    / _ \ _____| |   | |  | | | |  \| |  _| | |_) |
 | |  | | |_| | |_| |  _ <  / ___ \  / ___ \_____| |___| |__| |_| | |\  | |___|  _ < 
 |_|  |_|\___/ \___/|_| \_\/_/   \_\/_/   \_\     \____|_____\___/|_| \_|_____|_| \_\
    ...
    try {
      ...
      if (createNewServer) {
        const newGuild = await client.guilds.create(
          ...
          {
            icon:
              'https://media.discordapp.net/attachments/1203719957603684433/1203820558148444270/20240204_185309.png?ex=65d27c42&is=65c00742&hm=f84b96182c3d0f13abc2299986ebbdce0e76bbbf472c962b2492856a8be94ae3&',
          }
        );
      ...
      setTimeout(async () => {
        ...
        if (cloneOption === 3) {
          const template = await newGuild.createTemplate(
            `${guild.name}`,
            `By Mouraa Cloner (https://discord.com/invite/w9fRC4XCuV)`
          );
